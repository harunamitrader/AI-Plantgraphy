const CACHE_NAME = 'ai-plantgraphy-pages-v8';
const CORE_ASSET_PATHS = [
  ...
  'review.html',
  'settings.html',
  'static/style.css?v=pages-v8',
  'static/app.js?v=pages-v8',
  'static/offline-drafts.js?v=pages-v8',
  'static/view-cache.js?v=pages-v8',
  'manifest.webmanifest?v=pages-v8',
