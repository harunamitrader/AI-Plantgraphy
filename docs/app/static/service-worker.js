const CACHE_NAME = 'ai-plantgraphy-pages-v4';
const CORE_ASSET_PATHS = [
  ...
  'review.html',
  'settings.html',
  'static/style.css?v=pages-v4',
  'static/app.js?v=pages-v4',
  'static/offline-drafts.js?v=pages-v4',
  'manifest.webmanifest?v=pages-v4',
