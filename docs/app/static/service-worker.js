const CACHE_NAME = 'ai-plantgraphy-pages-v7';
const CORE_ASSET_PATHS = [
  ...
  'review.html',
  'settings.html',
  'static/style.css?v=pages-v7',
  'static/app.js?v=pages-v7',
  'static/offline-drafts.js?v=pages-v7',
  'manifest.webmanifest?v=pages-v7',
